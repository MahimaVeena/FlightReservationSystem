...
public class Main {
...

			{
				...
				if (op1 == 1) {
					...
					if (status)
						...
						System.out.println("Ticket with PNR number: " + PNRNumber + " couldn't be cancelled...either ticket with PNR number not found... " +
								"or you are trying to cancel ticket after flight departure ");
				}
	...
	static void printTicketDetails(Ticket ticket){
		System.out.println(" The PNR number is: "+ticket.getPNRNumber());
	}
	/**
	...
	static void addPassengerTickets() {
		...
		//test case
		System.out.println("print ticket details of ticket 1: (Tourist ticket)");
		printTicketDetails(t1);

		System.out.println("print ticket details of ticket2: (Regular ticket)");
